...
export type GetLessonsQuery = { __typename?: 'Query', lessons: Array<{ __typename?: 'Lesson', availableAt?: any | null, id: string, lessonType: LessonType, title: string, slug: string }> };
